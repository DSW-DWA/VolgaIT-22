...
function Page_1() {
  ...
  <header className="page_one-wapper_header"><img className="page_one-wapper_header-arrow prev_page" src={process.env.PUBLIC_URL + "img/left_arrow.svg"}/>
  ...
  <div className="page_one-wapper_main"> 
    ...
    <button className="page_one-wapper_main-btn-women next_page"><img className="page_one-wapper_main-btn-women-img" src={process.env.PUBLIC_URL+ "img/women_shadow.svg"}/>
      <div className="page_one-wapper_main-btn-women-text">Women's Styles</div>
    </button>
    <button className="page_one-wapper_main-btn-men next_page"><img className="page_one-wapper_main-btn-men-img" src={process.env.PUBLIC_URL + "img/men_shadow.svg"}/>
